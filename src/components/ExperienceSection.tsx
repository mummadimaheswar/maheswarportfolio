...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    date: "Jul 2024",
    description: "• Developed an AI-driven irrigation advisory platform integrating soil moisture sensor telemetry with external weather forecasting APIs to guide crop watering decisions.• Constructed a retrieval-augmented generation pipeline generating agronomy recommendations grounded in domain-specific agricultural documentation.• Formulated predictive irrigation logic analyzing environmental signals and contextual retrieval outputs to improve water-usage efficiency.• Organized environmental telemetry inside PostgreSQL relational storage enabling historical analysis and trend-driven irrigation planning.• Architected a modular Python backend processing layer enabling future integration of crop yield prediction and agricultural analytics models.",
    icon: <Award size={18} />,
